...
VALUE rb_funcall2(VALUE, RB_ID, int, const VALUE*);
VALUE rb_funcall3(VALUE, RB_ID, int, const VALUE*);
...
VALUE rb_block_call(VALUE,RB_ID,int,VALUE*,VALUE(*)(ANYARGS),VALUE);
...
typedef void (*rb_event_hook_func_t)(rb_event_flag_t, VALUE data, VALUE, RB_ID, VALUE klass);
